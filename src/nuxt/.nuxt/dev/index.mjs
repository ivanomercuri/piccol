...
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError } from 'file:///nuxt/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///nuxt/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///nuxt/node_modules/devalue/index.js';
import { renderToString } from 'file:///nuxt/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///nuxt/node_modules/ofetch/dist/node.mjs';
...
import { klona } from 'file:///nuxt/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///nuxt/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///nuxt/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///nuxt/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///nuxt/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///nuxt/node_modules/radix3/dist/index.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/nuxt/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/nuxt/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/nuxt/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
